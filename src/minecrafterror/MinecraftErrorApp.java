 ...
 */
public class MinecraftErrorApp extends SingleFrameApplication {

    /**
     * At startup create and show the main frame of the application.
     */
    @Override protected void startup() {
        show(new MinecraftErrorView(this));
    }
    ...
    public static void main(String[] args) {
        launch(MinecraftErrorApp.class, args);
    }
}
